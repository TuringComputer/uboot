 ...
 *
 * Configuration settings for the MX53-TURING Freescale board.
 *
...
#define CONFIG_MXC
#define CONFIG_MX53
#define CONFIG_MX53_TURING		// Edit asm-arm/arch-mx53/mmu.h to add this board
...
#define CONFIG_FASTBOOT_MANUFACTURER_STR  		"Turing"
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR 		"IMX53 TURING"
...
#define CONFIG_SYS_PROMPT		"MX53-TURING U-Boot > "
